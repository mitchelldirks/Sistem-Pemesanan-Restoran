                    ...
                    <li class="<?php if($_GET['p']!='menu'){echo '';}else{echo 'active';} ?>"><a class="tree-toggle nav-header"><span class="fa fa-list"></span> Menu  <span class="fa-angle-right fa right-arrow text-right"></span> </a>
                 ...
                 <li class="<?php if($_GET['p']!='karyawan'){echo '';}else{echo 'active';} ?>"><a class="tree-toggle nav-header" ><span class="fa fa-user"></span> Manajemen <span class="fa-angle-right fa right-arrow text-right"></span> </a>
                      <ul class="nav nav-list tree">
